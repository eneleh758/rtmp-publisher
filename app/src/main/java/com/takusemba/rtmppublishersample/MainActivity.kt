...
class MainActivity : AppCompatActivity(), PublisherListener {
    ...
    private lateinit var address: EditText // address 입력 EditText

//    private val url = BuildConfig.STREAMING_URL
    private var url = "rtmp://172.30.1.105/live/demo"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //address = findViewById(R.id.address) // address 입력 TextBox
...
// app/src/main/res/layout/activity_main.xml 내에 <TextView>끝나고 밑에
// <EditText
//        android:id="@+id/address"
//        android:layout_width="wrap_content"
//        android:layout_height="wrap_content"
//        android:layout_centerHorizontal="true"
//        android:hint="input address" />  넣기